...
if ($Config.Debug) {Write-Log -Level Debug "Begin Loop"}
...
if ($Config.Debug) {Write-Log -Level Debug "Complete Pools info"}
...
if ($Config.Debug) {Write-Log -Level Debug "API init"}
...
if ($Config.Debug) {Write-Log -Level Debug "Prepare currency stuff"}
...
if ($Config.Debug) {Write-Log -Level Debug "Donation stuff"}
...
if ($Config.Debug) {Write-Log -Level Debug "Load device information"}
...
if ($Config.Debug) {Write-Log -Level Debug "Request Pools data"}
...
if ($Config.Debug) {Write-Log -Level Debug "Request Balances data"}
...
if ($Config.Debug) {Write-Log -Level Debug "Collect Pools data"}
...
if ($Config.Debug) {Write-Log -Level Debug "Build AllPools"}
...
if ($Config.Debug) {Write-Log -Level Debug "Retrieve collected balances"}
...
if ($Config.Debug) {Write-Log -Level Debug "Loop AllMiners"}
...
if ($Config.Debug) {Write-Log -Level Debug "Open FW ports"}
...
if ($Config.Debug) {Write-Log -Level Debug "Apply watchdogs"}
...
if ($Config.Debug) {Write-Log -Level Debug "Update Active Miners"}
...
if ($Config.Debug) {Write-Log -Level Debug "Get best miners"}
...
if ($Config.Debug) {Write-Log -Level Debug "Stop active miners"}
...
if ($Config.Debug) {Write-Log -Level Debug "Start best miners"}
...
if ($Config.Debug) {Write-Log -Level Debug "Display mining information"}
...
if ($Config.Debug) {Write-Log -Level Debug "Display pool balances"}
...
if ($Config.Debug) {Write-Log -Level Debug "Garbage collection"}
...
if ($Config.Debug) {Write-Log -Level Verbose  "UpdateMinerData for $($Miner.Name) requested"}
