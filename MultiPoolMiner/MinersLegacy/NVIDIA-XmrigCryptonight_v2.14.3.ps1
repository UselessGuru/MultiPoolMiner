...
if ($CUDAVersion -lt [System.Version]"10.0.0") {
    $HashSHA256 = "B4D75602D0E67347C9DDAC449F5237A6EA3A4FA33B4636DC3D02A80A3F593C70"
    $Uri = "https://github.com/xmrig/xmrig-nvidia/releases/download/v2.14.3/xmrig-nvidia-2.14.3-cuda9_2-win64.zip"
}
elseif ($CUDAVersion -lt [System.Version]"10.1.0") {
    $HashSHA256 = "AFED5E523EBD67F0FA1BE1795821AED4E3928BBF54F48BF255E7E74888E2A63F"
    $Uri = "https://github.com/xmrig/xmrig-nvidia/releases/download/v2.14.3/xmrig-nvidia-2.14.3-cuda10-win64.zip"
}
else {
    $HashSHA256 = "4435C48BAE18B1010AEB456F235E03BCAC2D2C42967A8D05AA82D1AC56104D99"
