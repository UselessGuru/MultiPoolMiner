...
$HashSHA256 = ""
$Uri = "https://github.com/enerc/VulkanXMRMiner/releases/download/v0.3/vulkanxmrminer-0.3.zip"
...
if ($Miner_Config.Commands) {$Commands = $Miner_Config.Commands}
    ...
    $Commands = [PSCustomObject[]]@(
        ...
        [PSCustomObject]@{Algorithm = "cryptonight_v8_reversewaltz"; MinMemGB = 2; Params = ""} #CryptoightR, new in 2.10.0
        [PSCustomObject]@{Algorithm = "cryptonight_v7";              MinMemGB = 2; Params = ""} #CryptoightV7
        [PSCustomObject]@{Algorithm = "cryptonight_v7_stellite";     MinMemGB = 2; Params = ""} #CryptoightXtl
        [PSCustomObject]@{Algorithm = "cryptonight_v8";              MinMemGB = 2; Params = ""} #CryptoightV8
